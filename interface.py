...
class DNSGui(tk.Frame):
    ...
    def _build_widgets(self):
        ...
        self.map_path.grid(row=r, column=1, sticky='w')
        ...
        self.bpf = tk.Entry(self, width=30)
        self.bpf.insert(0, self.BPF_PRESETS[0])
        self.bpf.grid(row=r, column=1, sticky='w')
        ...
        r +=1
        tk.Label(self, text='Log output:').grid(row=r, columnspan=3)
        r +=1
